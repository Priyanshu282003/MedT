...
$query = $db->prepare("SELECT Report_Number, Date, Report_Type FROM lab_reports WHERE Patient_Number = ? ORDER BY Date DESC");
$query->bind_param("i", $patientNumber);
$query->execute();
...
<body>
    ...
    <div class="container text-center">
        <h2 class="mt-5 mb-4"><strong>Lab Reports</strong></h2>
    </div>
    ...
    <div class="container" margin-top="100px">
        <div class="table-responsive">
            ...
            if (isset($result) && $result->num_rows > 0) {
                ...
                echo "<thead><tr><th>Serial Number</th><th>Date</th><th>Report Type</th><th>Action</th></tr></thead><tbody>";
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='downloadLabReport.php?Report_Number=" . $row['Report_Number'] . "' class='btn btn-secondary'>Download Report</a></td>";
                    echo "</tr>";
                ...
                echo "<h5><strong>No lab reports found.</strong></h5>";
                echo "</div>";
            }
            ?>
        </div>
